  ...
  return (
    <div className="w-full font-inter py-6  p-4  bg-primary-color min-h-screen">
      <div className="max-w-[800px] mx-auto">
        <div className="flex items-center  justify-around md:w-96  ">
          <div className="h-56  text-sm font-semibold text-primary-color flex flex-col items-center items-start justify-center gap-4 rounded-tl-full rounded-b-full w-24  bg-secondary-color">
        ...
        <div className="py-6">
          <h2 className="text-2xl text-secondary-color ">{wine.name}</h2>
